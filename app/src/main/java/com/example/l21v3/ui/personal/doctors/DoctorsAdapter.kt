...
class EmployeeViewHolder(
    ...
    fun bind(employee: Employee, isExpanded: Boolean) {
        ...
        binding.unique1.text = "Реанимация: ${employee.uniqueSkill1}"
        binding.unique2.text = "Реабилитация: ${employee.uniqueSkill2}"
        binding.unique3.text = "Имплантология: ${employee.uniqueSkill3}"
        binding.unique4.text = "Кибернетизация: ${employee.uniqueSkill4}"
        binding.unique5.text = "Терапия: ${employee.uniqueSkill5}"
    }
}
