...
@HiltViewModel
class ScientistsViewModel @Inject constructor(
    ...
    private fun loadData() {
        viewModelScope.launch {
            try {
                val employees = employeeRepository.getEmployeesByRole("Science")
                val squads = squadRepository.getSquadByDepartment("Scientists")
